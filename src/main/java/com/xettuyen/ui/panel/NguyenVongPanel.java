...
public class NguyenVongPanel extends JPanel {
    ...
    PlaceholderTextField cccdField = new PlaceholderTextField("CCCD", 7);
    PlaceholderTextField manganhField = new PlaceholderTextField("Mã ngành", 8);
    ...
    cboKetqua.setPreferredSize(new Dimension(130, 38));
    ...
    RoundedButton btnXetTuyen = createRoundedButton("Xét tuyển", new Color(139, 92, 246));
...
private void configureSearchField(JTextField txtManganhSearch2) {
    txtManganhSearch2.setPreferredSize(new Dimension(140, 38));
    txtManganhSearch2.setFont(new Font("Segoe UI", Font.PLAIN, 14));
    txtManganhSearch2.setBackground(Color.WHITE);
    txtManganhSearch2.setForeground(new Color(30, 30, 30));
    txtManganhSearch2.setCaretColor(new Color(30, 30, 30));
    ((PlaceholderTextField) txtManganhSearch2).setPlaceholderColor(new Color(156, 163, 175));
}
