...
public class DiemCongPanel extends JPanel {
    ...
    private void configureSearchField(JTextField txtCccdSearch2) {
    txtCccdSearch2.setPreferredSize(new Dimension(150, 38));
    txtCccdSearch2.setFont(new Font("Segoe UI", Font.PLAIN, 14));
    txtCccdSearch2.setBackground(Color.WHITE);
    txtCccdSearch2.setForeground(new Color(30, 30, 30));
    txtCccdSearch2.setCaretColor(new Color(30, 30, 30));
    ((PlaceholderTextField) txtCccdSearch2).setPlaceholderColor(new Color(156, 163, 175));
}
