...
) ENGINE=InnoDB AUTO_INCREMENT=79148 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `xt_diemthi_dgnl_vsat`
--

DROP TABLE IF EXISTS `xt_diemthi_dgnl_vsat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `xt_diemthi_dgnl_vsat` (
  `id` int NOT NULL AUTO_INCREMENT,
  `cccd` varchar(20) NOT NULL,
  `dot_thi` varchar(45) DEFAULT NULL,
  `ma_dot_thi` varchar(45) NOT NULL,
  `ngay_thi` varchar(45) DEFAULT NULL,
  `nam` int DEFAULT NULL,
  `ma_mon` varchar(20) NOT NULL,
  `ten_mon` varchar(100) DEFAULT NULL,
  `diem` decimal(7,2) DEFAULT NULL,
  `thang_diem` varchar(20) DEFAULT NULL,
  `ma_dvtctdl` varchar(45) DEFAULT NULL,
  `ten_dvtctdl` varchar(100) DEFAULT NULL,
  `dv_keys` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_dv_keys` (`dv_keys`)
) ENGINE=InnoDB AUTO_INCREMENT=49512 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=49382 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `xt_nganh` (
  ...
  `n_tohopgoc` varchar(45) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=1466 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `xt_thisinhxettuyen25` (
  ...
  UNIQUE KEY `cccd_UNIQUE` (`cccd`)
) ENGINE=InnoDB AUTO_INCREMENT=49384 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-20 21:11:58
